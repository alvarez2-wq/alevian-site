...
export default function NavBar() {
  ...
  return (
    <>
      {/* Top bar */}
      <nav aria-label="Main navigation" className="fixed top-0 left-0 right-0 z-50 bg-white/[0.97] supports-[backdrop-filter]:bg-white/90 supports-[backdrop-filter]:backdrop-blur-md border-b border-slate-200/60">
